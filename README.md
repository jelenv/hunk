...
```toml
theme = "graphite"   # graphite, midnight, paper, one-light, ember, catppuccin-latte, catppuccin-mocha, custom
...
[custom_theme]
base = "graphite"    # graphite, midnight, paper, one-light, ember, catppuccin-latte, catppuccin-mocha
label = "My Theme"
accent = "#7fd1ff"
panel = "#10161d"
noteBorder = "#c49bff"
